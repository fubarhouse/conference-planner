...
export function parseDecisions(raw) {
  try {
    ...
    return {
      aliases: d && typeof d.aliases === 'object' && d.aliases ? d.aliases : {},
      ...
      snoozes: d && typeof d.snoozes === 'object' && d.snoozes ? d.snoozes : {},
    };
  } catch {
    return { aliases: {}, distinct: [], snoozes: {} };
  }
}
...
export function serializeDecisions(d) {
  return (
    JSON.stringify(
      { aliases: d.aliases || {}, distinct: d.distinct || [], snoozes: d.snoozes || {} },
      null,
      2,
    ) + '\n'
  );
...
export async function loadDecisions(store) {
  ...
  return { aliases: d.aliases, distinct: new Set(d.distinct), snoozes: d.snoozes };
}
